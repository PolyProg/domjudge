...
--
-- $Id: mysql_privileges.sql 3669 2011-10-10 15:29:57Z werth $
...
GRANT SELECT (probid, depends, name, cid, allow_submit, color)    ON problem    TO `domjudge_public`, `domjudge_plugin`;
...
GRANT SELECT (probid, depends, name, cid, allow_submit, color)    ON problem    TO `domjudge_team`;
