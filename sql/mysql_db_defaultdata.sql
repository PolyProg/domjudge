...
INSERT INTO `configuration` (`name`, `value`, `type`, `description`) VALUES ('show_country', '0', 'bool', 'Show country flag in the scoreboard? (No effect if affiliations are not shown.)');
INSERT INTO `configuration` (`name`, `value`, `type`, `description`) VALUES ('show_pending', '1', 'bool', 'Show pending submissions on the scoreboard?');
...
INSERT INTO `configuration` (`name`, `value`, `type`, `description`) VALUES ('show_balloons_postfreeze', '1', 'bool', 'Give out balloon notifications after the scoreboard has been frozen?');
INSERT INTO `configuration` (`name`, `value`, `type`, `description`) VALUES ('penalty_time', '20', 'int', 'Penalty time in minutes per wrong submission (if finally solved). Disabled for HC2 rules.');
...
INSERT INTO `configuration` (`name`, `value`, `type`, `description`) VALUES ('enable_printing', '1', 'bool', 'Enable teams and jury to send source code to a printer via the DOMjudge web interface.');
...
INSERT INTO `language` (`langid`, `name`, `allow_submit`, `allow_judge`, `time_factor`) VALUES ('txt',    'Text',     1, 1, 1);
...
INSERT INTO `team` (`login`, `name`, `categoryid`, `affilid`, `authtoken`, `hostname`, `room`, `comments`, `teampage_first_visited`) VALUES ('domjudge', 'DOMjudge', 1, NULL, '127.0.0.1', NULL, "jury", NULL, NULL);
